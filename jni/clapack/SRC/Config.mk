ALLAUX = maxloc.c ilaenv.c ieeeck.c lsamen.c xerbla.c xerbla_array.c iparmq.c	\
...
SXLASRC = sgesvxx.c sgerfsx.c sla_gerfsx_extended.c sla_geamv.c		\
...
CXLASRC =    cgesvxx.c cgerfsx.c cla_gerfsx_extended.c cla_geamv.c \
...
DXLASRC = dgesvxx.c dgerfsx.c dla_gerfsx_extended.c dla_geamv.c		\
...
ZXLASRC = zgesvxx.c zgerfsx.c zla_gerfsx_extended.c zla_geamv.c		\
...
ALLOBJ1= $(ALLAUX) $(SLASRC1) $(SLASRC2)
ALLOBJ2= $(CLASRC) 
ALLOBJ3= $(SCLAUX) $(DZLAUX)
ALLOBJ4= $(DLASRC1) $(DLASRC2)
ALLOBJ5= $(ZLASRC)
